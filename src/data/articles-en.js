...
`),
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      ...paragraphs(`
As more and more women postpone childbirth, choose not to have children, or decide to have fewer children, this reflects a broader social phenomenon: women are becoming less willing to bear the costs of reproduction and caregiving unconditionally.

One reason is that the cost of raising children in modern society continues to rise. Housing, education, healthcare, and childcare have all become increasingly expensive, while wage growth has largely stagnated. This creates a contradiction: capitalism requires a constant supply of new workers, yet it simultaneously raises the cost of producing and sustaining the next generation. As a result, more and more people find themselves unable to afford having children.

Another reason is that capitalism depends not only on wage labour but also on domestic labour. Workers are able to show up for work each day because someone has cooked meals, washed clothes, raised children, and cared for the sick. These activities produce and reproduce labour power itself. Yet capitalism generally does not pay for this work.

In modern economic systems, value is typically measured through wages and market exchange. Labour performed in factories, offices, and commercial activities can be quantified, recorded, and incorporated into measures of economic growth. However, a vast amount of labour that takes place within households remains outside the statistical framework. Caring for an infant does not generate a wage. Cooking for family members does not create market value. Providing companionship and care for the sick and the elderly is also difficult to incorporate into economic indicators.

As a consequence, many forms of work that sustain society become “invisible.” They are described as maternal love, responsibility, natural instinct, or family duty rather than as forms of labour that create social value. If the value generated by reproduction and caregiving benefits society as a whole, then the costs should not be borne entirely by individual households, and especially not by women alone.

Reproductive freedom is not merely the right to access contraception and abortion. It also means having full autonomy over one’s reproductive capacity. Historically, women have faced two opposite forms of oppression.

The first is forced reproduction, which is more widely recognized. Examples include abortion bans, restrictions on contraception, the expectation that women’s worth is tied to motherhood, the belief that women must marry and have children, and the treatment of childlessness as abnormal. Under such conditions, women are denied the right to refuse reproduction. The movements for contraception and abortion rights therefore fought for a simple principle: my body belongs to me, and I have the right to decide whether or not to become pregnant. This remains one of the major achievements of modern feminism.

The second form of oppression is forced non-reproduction, which is often overlooked. Throughout history, many groups have been denied the right to have children. Examples include the forced sterilization of Black women in the United States, eugenic sterilization policies targeting disabled people, compulsory birth-control programs imposed on Indigenous women, and reproductive restrictions directed at poor women. The underlying logic of these policies was that certain people’s children “should not be born.” In response, feminists later argued that reproductive justice includes not only the right not to have children, but also the right to have them.

If a person has the legal right to have children but lacks the material means to raise them, or has the legal right not to have children but cannot access contraception or abortion services, then those rights remain merely formal rights.

The problem is that society often fails to provide adequate support. Affordable childcare, parenting subsidies, healthcare protection, and paid parental leave are all essential. When such support is absent, it is unfair to demand that women assume greater reproductive responsibilities. Increasingly, women are no longer willing to sacrifice their lives in order to shoulder these burdens alone.
`),
    ],
  },
